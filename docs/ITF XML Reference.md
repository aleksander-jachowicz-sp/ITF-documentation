...
`clientTimeout` - optional attribute. This is the time in seconds that ITF will wait for the test case to finish. The default value is 300 seconds. This value will overwrite properties setting. 
